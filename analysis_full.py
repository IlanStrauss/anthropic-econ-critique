...
new_raw = pd.read_csv(
    "/Users/ilanstrauss/anthropic-econ-critique/data/release_2026_01_15/data/intermediate/aei_raw_claude_ai_2025-11-13_to_2025-11-20.csv"
)

# Load external data for enrichment
gdp = pd.read_csv("/Users/ilanstrauss/anthropic-econ-critique/data/release_2025_09_15/data/intermediate/gdp_2024_country.csv")
wap = pd.read_csv("/Users/ilanstrauss/anthropic-econ-critique/data/release_2025_09_15/data/intermediate/working_age_pop_2024_country.csv")
...
new_analysis.to_csv('/Users/ilanstrauss/anthropic-econ-critique/analysis_results.csv', index=False)
