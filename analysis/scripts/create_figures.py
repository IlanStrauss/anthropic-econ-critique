...
df = pd.read_csv("../analysis/output/analysis_results.csv")
...
plt.tight_layout()
plt.savefig('../analysis/output/figures/fig1_their_view_vs_ours.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../analysis/output/figures/fig2_uncertainty_by_group.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../analysis/output/figures/fig3_r_squared.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../analysis/output/figures/fig4_standard_errors.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig('../analysis/output/figures/fig5_outliers.png', dpi=150, bbox_inches='tight')
plt.close()
